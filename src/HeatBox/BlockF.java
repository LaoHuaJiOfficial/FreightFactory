...
public class BlockF extends Block {
    ...
    public class BuildF extends Building {
        ...
        public void buildConfiguration(Table table){
            if(OutputHeat){
                table.button(Icon.add, Styles.defaulti, () -> HeatBox.HeatAdd(OutputHeatAmount, OutputTempThreshold)).size(40f);
            }
            if(InputHeat){
                table.button(Icon.warning, Styles.defaulti, () -> HeatBox.HeatRemove(InputHeatAmount, InputTempThreshold)).size(40f);
            }
        }
         */
