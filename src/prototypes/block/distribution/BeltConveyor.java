...
public class BeltConveyor extends BlockF implements Autotiler {
    ...
    public class BeltConveyorBuild extends BuildF implements ChainedBuilding {

        public float speed = itemPerSecond * itemSpace / 56f;
        //parallel array data
        ...
        public @Nullable BeltConveyorBuild nextc;
        ...
        public void unitOn(Unit unit) {
            ...
            float mspeed = speed * tilesize * 56f;
