...
public class Bridge extends BlockF {
    ...
    //for autolink
    public @Nullable BridgeBuild lastBuild;
    ...
    public Bridge(String name){
        ...
        config(Point2.class, (BridgeBuild tile, Point2 i) -> tile.link = Point2.pack(i.x + tile.tileX(), i.y + tile.tileY()));
        //integer is not
        config(Integer.class, (BridgeBuild tile, Integer i) -> tile.link = i);
    }
    ...
    public boolean linkValid(Tile tile, Tile other, boolean checkDouble){
        ...
        return ((other.block() == tile.block() && tile.block() == this) || (!(tile.block() instanceof Bridge) && other.block() == this))
            && (other.team() == tile.team() || tile.block() != this)
            && (!checkDouble || ((BridgeBuild)other.build).link != tile.pos());
    }
    ...
    public class BridgeBuild extends BuildF {
        public int link = -1;
        ...
        public boolean onConfigureBuildTapped(Building other){
            //reverse connection
            if(other instanceof BridgeBuild b && b.link == pos()){
                configure(other.pos());
                other.configure(-1);
                return true;
            }
        ...
        public void checkIncoming(){
            ...
            while(idx < incoming.size){
                ...
                if(!linkValid(tile, other, false) || ((BridgeBuild)other.build).link != tile.pos()){
        ...
        public void updateTile(){
            ...
            if(!linkValid(tile, other)){
                ...
                var inc = ((BridgeBuild)other.build).incoming;
                int pos = tile.pos();
                if(!inc.contains(pos)){
                    inc.add(pos);
                }
        ...
        protected boolean linked(Building source){
            return source instanceof BridgeBuild && linkValid(source.tile, tile) && ((BridgeBuild)source).link == pos();
        }
