...
public class AreaDrill extends Block {
    ...
    public void setBars(){
        ...
        addBar("drillspeed", (AreaDrillBuild e) ->
    ...
    public void drawPlace(int x, int y, int rotation, boolean valid){
        ...
        Drawf.dashRect(valid ? Pal.accent : Pal.remove, getRect(Tmp.r1, x * tilesize, y * tilesize));
    ...
    public class AreaDrillBuild extends Building {
